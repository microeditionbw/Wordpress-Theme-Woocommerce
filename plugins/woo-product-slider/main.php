 ...
 * This action is documented in includes/class-woo-product-slider-activator.php
 */
function activate_woo_product_slider() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-woo-product-slider-activator.php';
	Woo_Product_Slider_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-woo-product-slider-deactivator.php
 */
function deactivate_woo_product_slider() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-woo-product-slider-deactivator.php';
	Woo_Product_Slider_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_woo_product_slider' );
register_deactivation_hook( __FILE__, 'deactivate_woo_product_slider' );
...
if ( ! class_exists( 'SP_WooCommerce_Product_Slider' ) ) {
	...
	class SP_WooCommerce_Product_Slider {
		...
		public function error_admin_notice() {
			$outline = '<div class="error"><p>' . __( 'Please install and activate <strong>WooCommerce</strong> plugin to make the <strong>Product Slider for WooCommerce</strong> work.', 'woo-product-slider' ) . '</p></div>';
			echo $outline;
		}
